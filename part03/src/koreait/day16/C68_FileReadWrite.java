...
public class C68_FileReadWrite {
	//main 메소드가 throws Exception 한다면 jvm 에게 넘깁니다. 처리내용은 printStackTrace결과와 동일.
	public static void main(String[] args) {

		String filename = "D:\\iclass05\\자바테스트0617.txt";
		
		try {
			fileWrite2(filename);
//			filename = "D:\\iclass05\\자바테스트0618.txt";   //없는 파일 테스트용
			fileRead(filename);
		} catch (FileNotFoundException e) {
			System.out.println("사용자 실행 오류 : " + e.getMessage());
			System.out.println("파일이 존해하는지 확인하세요.");
		}
